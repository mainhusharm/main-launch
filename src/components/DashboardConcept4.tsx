          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="bg-gray-800/60 border border-cyan-500/30 rounded-lg px-3 py-1 text-white text-sm focus:outline-none focus:border-cyan-400"
              >
    ...
    <>
      <style>{`
        ...
        .organic-sidebar {
            width: 250px;
            height: 100%;
            background: linear-gradient(135deg, rgba(0, 255, 200, 0.1), rgba(100, 200, 255, 0.1));
        ...
        .organic-logo {
            ...
            font-size: 24px;
            font-weight: bold;
            background: linear-gradient(45deg, #00ffc8, #64c8ff);
        ...
        .organic-menu-item:not(.active) {
            color: #fff;
        }

        .organic-menu-item::before {
            content: '';
            position: absolute;
            left: -100%;
            top: 0;
        ...
        .organic-menu-item:hover::before {
            left: 100%;
        }

        .organic-menu-item:hover {
      ...
      <div className="concept4">
        ...
        <div className="organic-sidebar">
            <div className="organic-logo">TraderEdgePro</div>
            <nav className="flex-1 p-4 overflow-y-auto">
              <div className="space-y-2">
                {sidebarTabs.map((item) => (
                  <div 
                    key={item.id}
                    className={`organic-menu-item ${activeTab === item.id ? 'active' : ''}`} 
